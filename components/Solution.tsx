          ...
          <div className="grid md:grid-cols-2 gap-6 pt-8">
            <div className="bg-gray-50 rounded-xl p-6 text-left space-y-3">
              ...
              <ul className="space-y-2 text-gray-600">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-red-600">✗</span>
                  <span>Bare links to click</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-red-600">✗</span>
                  <span>Waits for the customer to ask</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-primary-50 border-2 border-primary rounded-xl p-6 text-left space-y-3">
              ...
              <ul className="space-y-2 text-primary-900">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-primary">✓</span>
                  <span>Dynamic vehicle cards with real photos</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-primary">✓</span>
                  <span>Speaks first—by text or voice—like a real salesperson</span>
                </li>
              </ul>
            </div>
          </div>
